...
export async function handleGetCreatorBalance(req, res) {
    try {
...
export async function handleGetCreatorEarnings(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleCreatorWithdraw(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleGetCreatorPayouts(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleSetPayoutMethod(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleGetPayoutMethods(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleAdminListPayouts(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleAdminApprovePayout(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleAdminRejectPayout(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleAdminChargeback(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
        ...
        if (!gift_tx_id)
            return res.status(400).json({ error: 'gift_tx_id required' });
...
export async function handleShopBuy(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleShopRefund(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
...
export async function handleShopPurchases(req, res) {
    try {
        const userId = await getUserFromAuth(req);
        if (!userId)
            return res.status(401).json({ error: 'Unauthorized' });
