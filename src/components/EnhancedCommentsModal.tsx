...
export default function CommentsModal({ isOpen, onClose, videoId }: CommentsModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-background/95 rounded-t-2xl p-3 pb-safe h-1/2 w-full max-w-[480px] shadow-2xl flex flex-col border-2 border-b-0 border-[#C9A96E]"
        style={{ marginBottom: 'calc(var(--nav-height) + 2mm)', boxShadow: '0 -4px 30px rgba(201,169,110,0.25)' }}
