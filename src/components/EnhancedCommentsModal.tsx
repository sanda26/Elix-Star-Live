...
export default function CommentsModal({ isOpen, onClose, videoId }: CommentsModalProps) {
          ...
          {editingComment === comment.id ? (
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 bg-white/10 text-white px-3 py-1 rounded-lg border border-white/20 focus:border-[#D6A088] outline-none"
                placeholder="Edit comment..."
              />
              <button
                onClick={() => handleEditComment(comment.id)}
                className="text-[#D6A088] hover:text-[#B8935C]"
              >
                Save
              </button>
              <button
            ...
            <div className="mt-3">
              {comment.reply_count! > 0 && (
                <button
                  ...
                  className="text-sm text-[#D6A088] hover:text-[#B8935C] mb-2"
                >
          ...
          {replyingTo?.id === comment.id && (
            <div className="mt-3 flex gap-2">
              <input
                ...
                className="flex-1 bg-white/10 text-white px-3 py-2 rounded-lg border border-white/20 focus:border-[#D6A088] outline-none"
                autoFocus
              />
              <button
  ...
  return (
    <div
      className="fixed inset-0 bg-black/80 backdrop-blur-sm z-modals flex items-end justify-center"
      onClick={onClose}
    >
      <div
          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="flex-1 flex gap-2">
              <input
                ...
                className="flex-1 bg-black text-white px-3 py-2 rounded-lg border border-white/10 focus:border-secondary outline-none text-sm"
                onKeyDown={(e) => {
