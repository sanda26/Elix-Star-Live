      ...
      <div className="relative w-full max-w-[480px] h-full bg-[#13151A] overflow-hidden border-none">
        ...
        <div className="relative z-10 h-full pointer-events-none">
          ...
          <div className="relative flex flex-col h-full pointer-events-none">
                  ...
                  <div className="px-3" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 2px)' }}>
                    <div className="flex items-start justify-between gap-2">
                      <div className="pointer-events-auto flex flex-col gap-2">
                        {/* BROADCASTER INFO */}
                        <div className="px-0 py-1 animate-luxury-fade-in -ml-2 relative" style={{ transform: 'translateY(-3mm)' }}>
            ...
            <div className="chat-zone fixed left-0 right-0 bottom-[calc(52px+max(8px,env(safe-area-inset-bottom)))] z-[20] flex justify-start pointer-events-none">
              <div 
