  ...
  return (
    <div className="min-h-[100dvh] h-[100dvh] w-full flex justify-center bg-[#0A0B0E]">
      ...
      {SPEED_CHALLENGE_ENABLED && speedChallengeCountdown !== null && (
            ...
            <div className="absolute bottom-1 left-0 right-0 px-3 py-2 flex items-center justify-between flex-none pointer-events-none relative z-30" style={{ transform: 'translateY(6mm)' }}>
