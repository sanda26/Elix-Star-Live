...
export default function LiveStream() {
  ...
  */
  ...
  return (
    <div className="flex items-start justify-center min-h-[100dvh] h-[100dvh] bg-[#13151A]" style={{paddingTop:'calc(var(--safe-top) + 14mm)', paddingBottom:'calc(var(--safe-bottom) + 18mm)'}}>
