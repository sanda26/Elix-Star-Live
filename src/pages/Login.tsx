...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 xs:p-3 sm:p-4">
      <div className="w-full max-w-[420px] xs:max-w-[320px] sm:max-w-[380px] bg-white/5 border border-white/10 rounded-2xl p-6 xs:p-4 sm:p-5">
        ...
        <form onSubmit={onSubmit} className="space-y-4 xs:space-y-3 sm:space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/10 rounded-xl pl-10 xs:pl-9 pr-3 py-3 xs:py-2.5 text-fluid-sm text-white outline-none focus:border-[#E6B36A]/50 placeholder:text-white/40"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/10 rounded-xl pl-10 xs:pl-9 pr-10 xs:pr-9 py-3 xs:py-2.5 text-fluid-sm text-white outline-none focus:border-[#E6B36A]/50 placeholder:text-white/40"
                placeholder="••••••••"
          ...
          <button
            ...
            className="w-full bg-[#E6B36A] text-black font-bold rounded-xl py-3 xs:py-2.5 text-fluid-sm disabled:opacity-60 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-6 xs:mt-4 text-center space-y-2">
          ...
          <Link to="/register" className="block text-fluid-sm text-[#E6B36A] hover:underline">
