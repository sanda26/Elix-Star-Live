...
export default function Profile() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#13151A] text-white flex justify-center px-2">
      <div className="w-full max-w-[480px] h-[100dvh] flex flex-col bg-[#13151A] rounded-3xl overflow-hidden overflow-y-auto pt-[calc(var(--safe-top)+46px)] pb-[calc(var(--safe-bottom)+70px)]">
