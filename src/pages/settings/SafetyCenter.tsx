    ...
    <div className="min-h-[100dvh] bg-[#121212] text-[#00f2ea] flex justify-center px-2">
      ...
      <div className="px-4 py-6">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-gradient-to-br from-[#00f2ea] to-[#00f2ea] rounded-full mx-auto mb-4 flex items-center justify-center">
            <Shield className="w-10 h-10 text-[#00f2ea]" />
          </div>
        ...
        <Section title="Safety Resources">
          <InfoCard
            icon={<AlertTriangle className="w-6 h-6 text-[#00f2ea]" />}
            title="Community Guidelines"
            description="Learn what's allowed on Elix Star"
            onClick={() => navigate('/guidelines')}
          />
          <InfoCard
            icon={<HelpCircle className="w-6 h-6 text-[#00f2ea]" />}
            title="Safety Tips"
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-[#00f2ea]/60 mb-3">Need to talk to someone?</p>
          <button
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-6">
      <h3 className="text-sm font-semibold text-[#00f2ea]/60 mb-3 px-2">{title}</h3>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-[#00f2ea]/60">{description}</p>
      </div>
    </button>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-xs text-[#00f2ea]/60">{description}</p>
      </div>
    </button>
  );
}
